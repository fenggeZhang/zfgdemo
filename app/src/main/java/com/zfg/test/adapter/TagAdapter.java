...
import com.zfg.test.interfaces.TagWithListener;
import com.zfg.test.weigt.BaseTagView;
        ...
        for (T item : source) {
            ...
            view.setListener(new TagWithListener<T>() {
                ...
                public void onItemSelect(T item) {
                    if (mode == TagFlowLayout.MODE_SHOW_SELECT) {
                        return;
                    } else if (mode == TagFlowLayout.MODE_SINGLE_SELECT) {
